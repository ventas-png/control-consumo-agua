...
| `contabilidad-ledger.e2e.ts` | Selector de contabilidad: la empresa y cada proyecto llevan libros propios; bandeja de pendientes, tipos de cargo y auxiliares cargan (sólo lectura) |
