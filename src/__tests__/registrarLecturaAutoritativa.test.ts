...
// Guards ESTÁTICOS de la captura autoritativa de lecturas (20260910000200 y
// 20260910000300).
//
...
const RPC = resolve('supabase/migrations/20260910000200_registrar_lectura_autoritativa.sql')
const REPORTE = resolve('supabase/migrations/20260910000300_reporte_inconsistencias_lecturas.sql')
