...
// Guards del gate de evidencia (20260907000400).
//
...
const MIG = resolve('supabase/migrations/20260907000400_evidencia_al_cerrar.sql')
...
describe('20260907000400 · el trigger gatea la TRANSICIÓN, no la fila', () => {
...
describe('20260907000400 · la salida de emergencia no es un bypass', () => {
...
describe('20260907000400 · qué se exige', () => {
  ...
  it('marca sus errores con EVIDENCIA: para poder traducirlos en la UI', () => {
    // Misma convención que PLANTILLA_RECURSO: (20260904000300). Sin el marcador,
...
describe('20260907000400 · el sandbox conductual está cableado a CI', () => {
