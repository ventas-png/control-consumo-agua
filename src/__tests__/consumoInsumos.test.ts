...
// Guards del consumo de insumos (20260907000500).
//
...
const MIG = resolve('supabase/migrations/20260907000500_consumo_insumos.sql')
...
describe('20260907000500 · la idempotencia no es opcional', () => {
...
describe('20260907000500 · la autorización es el punto de la RPC', () => {
...
describe('20260907000500 · el motor de existencias no se duplica', () => {
...
describe('20260907000500 · el sandbox conductual está cableado a CI', () => {
