...
// Guards ESTÁTICOS de las rutinas de limpieza (20260907000200).
//
...
const MIG_RUTINAS = '20260907000200_rutinas_limpieza.sql'
...
describe('20260907000200 · el tenant se congela con FKs COMPUESTAS', () => {
  ...
  it('las anclas UNIQUE que esas FKs necesitan quedan declaradas', () => {
    ...
    // La de la propia rutina va inline, y la de plantillas viene de 20260904000200.
    expect(sqlRutinas).toMatch(/CONSTRAINT rutinas_id_tenant_uq UNIQUE \(id, company_id, project_id\)/i)
    expect(codigo.get('20260904000200_plantillas_catalogo_actividades.sql')!)
...
describe('20260907000200 · RBAC: las rutinas son de Limpieza', () => {
  ...
  it('el DELETE va por permiso del tab y no por owner/admin', () => {
    // Desviación deliberada del convenio, igual que en 20260904000300: quitar un
...
describe('20260907000200 · la receta no se contradice a sí misma', () => {
