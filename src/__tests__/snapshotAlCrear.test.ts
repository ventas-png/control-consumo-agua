...
// Guards del snapshot al crear la tarea (20260907000600).
//
...
//     puso a propósito — y el gate de 20260907000400 dejaría de exigirlas sin
//     que nadie se entere.

const MIG = resolve('supabase/migrations/20260907000600_snapshot_al_crear_tarea.sql')
...
describe('20260907000600 · el trigger sólo puede APRETAR', () => {
...
describe('20260907000600 · qué se copia y cuándo', () => {
...
describe('20260907000600 · el privilegio no es decorativo', () => {
...
describe('20260907000600 · la pantalla dejó de duplicar la regla', () => {
...
describe('20260907000600 · el sandbox conductual está cableado a CI', () => {
