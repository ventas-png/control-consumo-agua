    ...
    <div style={{ padding: 16 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 10, marginBottom: 20 }}>
        <div style={{ background: '#f0f9ff', borderRadius: 10, padding: '12px 16px' }}>
          <div style={{ fontSize: 20, fontWeight: 800, color: '#0369a1' }}>{promedio}</div>
          <div style={{ fontSize: 11, color: '#0369a1', fontWeight: 600 }}>Puntaje promedio del condominio</div>
        </div>
      ...
      <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 12, padding: 16 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          {scores.map((s, i) => {
            ...
            return (
              <div key={s.unidad.id} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 12px', background: '#f9fafb', borderRadius: 8 }}>
                <div style={{ width: 22, color: '#9ca3af', fontSize: 11, textAlign: 'right', flexShrink: 0 }}>{i + 1}</div>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 12, fontWeight: 600, color: '#0f172a' }}>{s.unidad.nombre}</div>
                  <div style={{ fontSize: 10, color: '#9ca3af' }}>
                ...
                {/* Mini barra */}
                <div style={{ width: 60, background: '#e5e7eb', borderRadius: 4, height: 6, flexShrink: 0 }}>
      ...
      <div style={{ marginTop: 12, padding: '10px 14px', background: '#f8fafc', borderRadius: 8, fontSize: 11, color: '#6b7280' }}>
