...
export function LecturasSection({
  ...
  // vez de regalarse. Lo exige el servidor (20260910000000).
  ...
  // servidor desde el contador (20260910000000). Derivarlo aquí era, además de
  ...
  // PREVISUALIZACIÓN, no decisión. Desde 20260910000000 la lectura anterior —y
              ...
              <>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '20px' }}>
                  ...
                  {/* El «Estado Pago» de la captura ya no existe. Marcar una
                      ...
                      (20260910000000) y cobrarla es otro acto, con su permiso.
