...
// El pipeline de compresión lo comparte la captura del marcaje de turno, que no
// usa este uploader pero tiene que producir el mismo JPEG. Ver lib/imageCompress.
