...
export interface BloqueTurno {
   ...
   *  bloque (20260912000300). `null` = el bloque no tiene jornada, o se planificó
...
export interface PlantillaHorario {
  ...
  // ── La vara de la jornada (20260912000300). Declarada, todavía sin efectos:
...
/** Cuánto descanso da UNA jornada de UN tipo de pausa (20260912000300). */
