...
export interface BloqueTurno {
   ...
   *  bloque (20260909000000). `null` = el bloque no tiene jornada, o se planificó
...
export interface PlantillaHorario {
  ...
  // ── La vara de la jornada (20260909000000). Declarada, todavía sin efectos:
...
/** Cuánto descanso da UNA jornada de UN tipo de pausa (20260909000000). */
