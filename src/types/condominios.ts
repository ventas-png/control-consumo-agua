// cond:C9 — Tipos del módulo Condominios consolidados en este archivo.
// Hoy contiene todo el dominio (Fases 1-43, ~2.300 L). En PRs futuros se
// puede sub-particionar por sub-dominio (cuotas/visitantes/amenidades/...)
// usando un barrel pattern bajo `./condominios/<subdominio>.ts`.
//
// El barrel `src/types/index.ts` re-exporta todo vía `export *` para
// preservar `import { CuotaCondominio } from '@/types'` ya existente.
