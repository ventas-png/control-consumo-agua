...
-- ── Referencias a la PERDEDORA (' lobby ', …0004) ───────────────────────────
-- Sin estas filas el re-apuntado se verificaría en vacío y el test pasaría por
-- casualidad. Cubren las 4 FKs entrantes.
