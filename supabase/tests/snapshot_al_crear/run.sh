#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════════════
# Verificación EJECUTABLE del snapshot al crear la tarea (20260907000600).
#
# POR QUÉ EXISTE
...
# 20260907000400 SÍ rechace un cierre que hoy pasa sin nada.
#
...
#   C · NO CAMBIA LO QUE  la materialización (20260907000300) da EXACTAMENTE el
