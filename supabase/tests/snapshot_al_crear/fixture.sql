-- Fixture para EJECUTAR 20260905000600 (snapshot al crear la tarea) contra un
-- Postgres de verdad. El run.sh aplica encima las migraciones REALES
-- 20260904000000, 000100, 000200, 20260905000200, 000300, 000400 y 000600.
--
...
--
-- Se aplica ADEMÁS 20260905000400 (evidencia al cerrar), que consumo_insumos no
