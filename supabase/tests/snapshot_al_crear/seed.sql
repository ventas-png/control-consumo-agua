...
-- `plantillas_tarea_cargo` las crea 20260904000100, y el trigger que se prueba
-- lo crea 20260905000600 — insertar las tareas ES lo que lo dispara.
--
...
--
-- Va en OTRO bloque porque `uq_tareas_bloque_plantilla` (20260905000100) impide
