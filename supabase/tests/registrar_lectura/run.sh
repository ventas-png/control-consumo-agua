#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════════════
# Verificación EJECUTABLE de 20260910000200 + 20260910000300: la lectura de
...
RAIZ="$(cd "$AQUI/../../.." && pwd)"
MIG_RPC="$RAIZ/supabase/migrations/20260910000200_registrar_lectura_autoritativa.sql"
MIG_REP="$RAIZ/supabase/migrations/20260910000300_reporte_inconsistencias_lecturas.sql"
