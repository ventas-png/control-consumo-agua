-- Fixture para EJECUTAR 20260907000300 (materializar rutinas) contra un
-- Postgres de verdad. Reproduce el estado anterior a la serie 20260904*, y el
-- run.sh aplica encima las migraciones REALES 20260904000100, 000100 y
-- 20260907000200 — de ahí salen el catálogo extendido, las anclas de tenant y
