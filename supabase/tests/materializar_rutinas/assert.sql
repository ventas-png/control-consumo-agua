...
-- Invariantes de 20260905000300 (materializar rutinas), verificadas EJECUTANDO
...
BEGIN
  ...
  RAISE NOTICE 'OK 5  la tarea anulada no revive: anular es una decisión, no un hueco';
END;
$$;
