#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════════════
# Verificación EJECUTABLE de la materialización de rutinas (20260905000300).
#
# POR QUÉ EXISTE
...
MIG_RUTINAS="$RAIZ/supabase/migrations/20260905000200_rutinas_limpieza.sql"
MIG_MAT="$RAIZ/supabase/migrations/20260905000300_materializar_rutinas.sql"
