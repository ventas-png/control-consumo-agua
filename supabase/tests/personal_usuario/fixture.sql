-- Fixture mínimo para EJECUTAR la migración 20260826000000 contra un Postgres
-- de verdad. Reproduce solo lo que el vínculo empleado ↔ cuenta toca.
--
...
-- Dina tiene el permiso del tab por rol RBAC; Sara no tiene ninguno.
