-- Fixture para EJECUTAR 20260905000400 (evidencia al cerrar) contra un Postgres
-- de verdad. El run.sh aplica encima las migraciones REALES 20260904000000,
-- 000100, 20260905000200, 000300 y 000400.
--
...
-- (`requiere_comentario`, `checklist`) que las crea 20260905000300.
--
