#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════════════
# Verificación EJECUTABLE del gate de evidencia (20260905000400).
#
# POR QUÉ EXISTE
...
echo
echo "✅ evidencia_al_cerrar: 9 invariantes (lo que se exige, lo que no, y lo"
echo "   que no se re-valida), migración idempotente."
