...
-- 20260907000300 (`requiere_comentario`, `requiere_checklist`, `checklist`).
--
...
-- Para la invariante 10: pasa el control Y tiene que quedar sellada. Se cierra
-- con el gesto REAL de la app (estado + completada_en), que es lo que dispara
-- trg_sellar_cierre.
INSERT INTO public.tareas_bloque (id, bloque_id, titulo, requiere_foto) VALUES
  ('80000000-0000-0000-0000-0000000000a1', '70000000-0000-0000-0000-000000000001',
   'Exige foto, se cerrará con ella y debe quedar sellada', true);
