-- Fixture para EJECUTAR 20260908000000 + 20260908000200 contra un Postgres de
-- verdad. Parte del fixture del marcaje y agrega lo que necesita el cómputo de
-- horas —la pieza que hace que ANULAR signifique algo—: las dos funciones de
-- aritmética de jornada tal como están en producción (no stubs: los números que
-- se comprueban dependen de ellas), el guard de empresa, y las dos tablas que
-- `calcular_horas_personal` cruza.
--
