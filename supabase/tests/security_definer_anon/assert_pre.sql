-- Reproduce el hallazgo del guard ANTES de la migración: las 8 funciones son
...
BEGIN
  FOREACH fn IN ARRAY fns LOOP
    ...
    END IF;
  END LOOP;
  RAISE NOTICE 'OK    hallazgo reproducido: anon puede ejecutar las 8 (grant implícito de PUBLIC)';
...
-- 8: debe verlas TODAS antes de la migración.
SELECT public.chk(
  ...
  8,
  'consulta (a) del guard ve los 8 hallazgos antes de la migración');
