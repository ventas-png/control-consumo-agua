#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════════════
# La reversa de 20260912020100 es DDL ejecutable, y repone lo que había.
#
# POR QUÉ EXISTE
# 20260912020100 retira tres funciones que sólo viven en producción. Una
...
RAIZ="$(cd "$AQUI/../../.." && pwd)"
REVERSA="$RAIZ/supabase/reversas/20260912020100_reponer_helpers_rbac_huerfanos.sql"
