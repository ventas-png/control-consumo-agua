-- Fixture para EJECUTAR 20260905000500 (consumo de insumos) contra un Postgres
-- de verdad. El run.sh aplica encima las migraciones REALES 20260904000000,
-- 000100, 000200, 20260905000200, 000300 y 000500.
--
...
--
-- `inventario_condominio` está porque 20260904000200 le crea un ancla UNIQUE y
