...
// Orígenes de producción siempre permitidos (mismo set que el handler tenía
// inline; create-billing-portal-session mantiene su propia copia, igual que
// el código original duplicaba estas funciones por función).
