...
/**
 * ¿La fila de la bóveda trae credenciales utilizables? (al menos una clave).
 * Decide el override locación→empresa en cargarCredencialesPac: credenciales
 * vacías de la locación NO tapan las de la empresa.
 */
export function hayCredenciales(
  cred: CredencialesPacPorAmbiente | null | undefined,
): cred is CredencialesPacPorAmbiente {
  return !!cred && Object.keys(cred).length > 0
}
