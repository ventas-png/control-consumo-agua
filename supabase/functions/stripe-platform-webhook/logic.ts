...
export function buildSubscriptionRow(
  ...
  // P0 #2 (dunning): el reloj de past_due lo calcula el handler, que es quien
  // conoce la fila existente (hay que conservar el sello original entre
  // reintentos y limpiarlo al recuperarse). Aquí solo se transporta al row.
