...
--
-- QUÉ FALTABA
-- El catálogo de actividades (plantillas_tarea_cargo, 20260904000100) dice QUÉ
-- se hace y con qué recursos (20260904000200), pero no había forma de agrupar
...
--
-- POR QUÉ AHORA VALE LA PENA MATERIALIZAR. Hasta 20260905000100,
...
--
-- TENANT — el mismo molde de 20260904000200, sin reinventarlo:
...
--   Las anclas UNIQUE de plantillas_tarea_cargo viven en 20260904000100; las de
...
-- que hizo el SELECT de plantillas en 20260904000100.
--
...
CREATE TABLE IF NOT EXISTS public.rutinas_limpieza (
  ...
  -- Mismo dominio que plantillas_cargo_servicio_check (20260904000100), sin el
...
-- una decisión: se reutiliza el normalizador de 20260904000000 (minúsculas,
...
CREATE TABLE IF NOT EXISTS public.rutina_actividades (
  ...
  -- distinguir (el mismo criterio que uq_tareas_bloque_plantilla, 20260905000100).
...
-- ────────────────────────────────────────────────────────────────────────────
-- Gemela de plantilla_recurso_coherente (20260904000200), con el padre en
...
-- deliberada que 20260904000200: quitar un paso de una rutina es edición de
-- catálogo, no destrucción de historial (el historial lo protegen los RESTRICT
-- de esta serie y la anulación lógica de 20260905000100). Con owner/admin, el
...
-- —la trampa que costó el assert 7 de 20260905000100— y una rutina invisible
