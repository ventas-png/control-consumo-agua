-- ============================================================
-- Agrega 'comunicacion' al CHECK constraint de user_module_permissions
-- y actualiza populate_default_module_permissions para incluirlo.
-- ============================================================

-- 1. Reemplazar constraint CHECK
ALTER TABLE public.user_module_permissions
  DROP CONSTRAINT chk_module_key;
...
-- 2. Actualizar función de defaults para incluir 'comunicacion'
