...
-- (20260905000300) copia el snapshot completo. Las otras dos —«desde plantilla»
...
-- simétricas:
--
--   · `instrucciones_seguridad` es lo grave. 20260905000400 puso las
...
-- Mismo argumento que 20260905000500: son tres rutas de escritura, y un trigger
...
-- `boolean NOT NULL DEFAULT false` (20260905000300). NO hay forma de distinguir
...
-- `tareas_bloque_insert` (20260905000100) acepta `tareas_personal`, `turnos` y
-- `prog_limpieza`. Pero `plantillas_tarea_cargo_select` (20260904000100) acepta
