...
-- `plantilla_tarea_suministros` (20260904000200) declara qué insumos lleva cada
...
--
-- Es el mismo patrón de dato muerto que 20260905000400 cerró con
...
-- 20260905000300: editar el catálogo mañana no debe reescribir lo que se pidió
...
-- (20260905000300) y, en TareasPersonalTab, «desde plantilla» y «cargar
...
CREATE TABLE IF NOT EXISTS public.tarea_bloque_suministros (
  ...
  -- FK compuesta: el ancla `suministros_id_tenant_uq` la creó 20260904000200.
...
BEGIN
  ...
  -- Los mismos gates que el UPDATE de `tareas_bloque` (20260905000100): quien
...
-- 5. RLS
-- ────────────────────────────────────────────────────────────────────────────
-- Molde de 20260905000100: el tenant de la tarea se deriva del bloque, y los
