...
--
-- La serie 20260904*–20260905000300 agravó el desperdicio: el catálogo declara
-- checklist, comentario obligatorio e instrucciones de seguridad, y
-- 20260905000300 los COPIA a cada tarea al materializar… para que nadie los
...
-- por qué. Es el patrón de `motivo_anulacion` (20260905000100) y es mejor que
...
-- `checklist` guarda la DEFINICIÓN de pasos (snapshot de 20260905000300).
