...
-- 20260905000200 dejó la receta (rutinas_limpieza + rutina_actividades) pero no
...
-- lo que 20260904000100 agregó al catálogo.
--
...
-- lógica de 20260905000100, el snapshot `area` de 20260904000000), así que aquí
-- se copia.
--
...
-- `uq_tareas_bloque_plantilla (bloque_id, plantilla_id)` de 20260905000100, y el
...
-- par que ya acepta el INSERT de tareas_bloque en 20260905000100.
--
...
BEGIN
  ...
  WITH candidatas AS (
    SELECT
      ...
      -- 20260905000200), así que no puede colarse un área ajena.
